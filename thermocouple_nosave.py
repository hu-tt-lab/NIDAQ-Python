...
def playrec(
    ...
    with ni.Task() as read_task, ni.Task() as write_task:
        ...
        for i in input_mapping:
            aichan = read_task.ai_channels.add_ai_thrmcpl_chan(i, thermocouple_type=ThermocoupleType.T)
            aichan.ai_min = -10
            aichan.ai_max = 10
...
if __name__ == "__main__":
    ...
    indata = playrec(sig, sr, [f"{device}/ai0"], [f"{device}/ao0"])
